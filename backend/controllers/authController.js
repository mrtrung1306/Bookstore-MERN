...
const getAuth = (async function (req, res, next) {
  ResHelper.ResponseSend(res, true, 200, req.user)
});

const forgotPasswordAuth = (async function (req, res, next) {
...
const resetPasswordAuth = ('/ResetPassword/:token', async function (req, res, next) {
  let user = await userModel.findOne({
...
const logoutAuth = (async function (req, res, next) {
...
const registerAuth = (async function (req, res, next) {
